...
const AdmissionForm = (() => {
  ...
  return (
    <>
      ...
      <div className="row d-flex mx-0 px-0 align-items-center justify-content-center" style={{ marginTop: '3.7rem' }}>
        ...
        <div className="mainRegContainer" >
          <div className="row  d-flex align-items-center justify-content-center mx-0 px-0">
            ...
            <div className="col-12  " style={{ color: 'maroon', borderTop: 'var(--my-border)' }}>
              <div className="row small" style={{ color: GuidText, background: GuidBg }} id='AdmGuidBg'>
                <div className="col d-flex justify-content-between">
                  <ImportantGuids />
                  <Time />
                </div>
              </div>
              <div className="container-fluid shadow-lg my-3 py-2 px-5">
