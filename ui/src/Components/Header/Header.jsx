...
function Header() {
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg fixed-top py-1" style={{ background: 'var(--darkRed)' }} id="TopNavBar">

                <div className="d-flex align-items-center justify-content-between fixed-top py-1" style={{ background: 'var(--topNavBgColor)', width: '100vw', fontSize: '0.7rem' }}>
                ...
                <div className="container-fluid fw-medium text-uppercase mt-3" id='ToperNav'>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav m-auto w-100 d-flex justify-content-between align-items-center ">
                            ...
                            <li className="nav-item">
                                <Link to="/gallary" className="nav-link"><i className="bi bi-image-fill"></i> Gallary</Link>
                            </li>
                            <li className="nav-item dropdown">
